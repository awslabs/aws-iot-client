...
public class DeleteAllSubscriptionDefinitionsCommandHandler implements GreengrassCommandHandler, UsesStream<DefinitionInformation> {
    ...
    private Void run() {
        getStream()
                ...
                .forEach(greengrassV1Helper::deleteSubscriptionDefinition);
    ...
    public Stream<DefinitionInformation> getStream() {
        List<String> immutableSubscriptionDefinitionIds = greengrassV1Helper.getImmutableSubscriptionDefinitionVersionResponses()
                .map(GetSubscriptionDefinitionVersionResponse::id)
                .toList();

        return greengrassV1Helper.getSubscriptionDefinitions()
